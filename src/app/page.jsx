  ...
  return (
    <>
      <section className="mt-0 w-full min-h-fit  bg-slate-300 ">
        <div class=" w-full flex flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-red-50 via-white-50 to-orange-50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800">
          <h1 class="mx-auto max-w-3xl font-display text-3xl font-bold tracking-normal text-white-300 dark:text-gray-300 sm:text-7xl">
            Revolutionize Your
            <span class="relative whitespace-nowrap text-[#3b3486] dark:text-gray-300">
              Hostel Operations
            </span>
            <span class="relative whitespace-nowrap text-red-700 dark:text-orange-300">
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
                class="absolute top-2/3 left-0 h-[0.58em] w-full fill-slate-900 dark:fill-orange-300/60"
              ...
              <span class="relative text-[#3b3486]">with Hostello</span>
            </span>
          </h1>
          <h2 class="mx-auto mt-12 max-w-4xl  sm:text-white-400 text-lg text-white-500 lg:text-2xl dark:text-gray-300 leading-7">
          ...
          <div className="text-[20px] md:text-[50px] md:p-[20px] text-blue-700">
            Hostel{" "}
            <Typed
              strings={[
                "Analytics",
          ...
          <a
            class="bg-[#3b3686] dark:bg-gray-800 rounded-xl text-white dark:text-gray-300 font-medium px-4 py-3 sm:mt-10 mt-8 hover:bg-orange-500 dark:hover:bg-gray-600 transition"
            href=""
          >
            Get started
          </a>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-x-4 gap-y-28 lg:gap-y-16">
            <div className="relative group h-48 flex   flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                <a href="#" className="block">
                    <div className="h-28">
                        <div
                            class="absolute -top-20 lg:top-[-10%] left-[5%] z-40  group-hover:top-[-30%] group-hover:opacity-[0.9]   duration-300 w-[90%] h-48 bg-[#3B3486] rounded-xl justify-items-center align-middle">
            ...
            <div class="relative group h-48 flex   flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                <a href="#" class="block">
                    <div class="h-28">
                        <div
                            class="absolute -top-20 lg:top-[-10%] left-[5%] z-10  group-hover:top-[-30%] group-hover:opacity-[0.9]   duration-300 w-[90%] h-48 bg-[#3B3486] rounded-xl justify-items-center align-middle">
